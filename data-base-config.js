          ...
          const sql_create_default_users =`INSERT INTO Users (id, email, password) VALUES
          (1, 'adminuser@mobilender.com', '${bcrypt.hashSync('notsecret', bcrypt.genSaltSync(8), null)}'),
          (2, 'defaultuser@mobilender.com', '${bcrypt.hashSync('notsecret', bcrypt.genSaltSync(8),null)}');`
